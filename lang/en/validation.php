    ...
    */
    ...
    'custom' => [
        'name' => [
            ...
            'min' => 'The length of the :attribute must be at least :min characters',
        ...
        'code' => [
            'unique' => 'The code already exists',
        ],
        'city_id' => [
            'prohibited' => 'You cannot choose a city if you are not a resident',
            'exists' => 'The selected city is not available',
            'integer' => 'The selected city is not available',
        ],
        'mobile' => [
